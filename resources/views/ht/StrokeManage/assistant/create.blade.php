                                            ...
                                            <div class="tabbable">
                                                ...
                                                <form>
                                                    <div class="form-item">
                                                        ...
                                                        <div class="d-inline mr-m"><input type="checkbox" name="type" class="mr-s">採購飲用水設備</div>
                                                    ...
                                                    <div class="form-item">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="客戶代碼">
                                                    </div>
                                                    <div class="form-item">
                                                        <label class="d-block title-deco">聯絡地址</label>
                                                        <input type="text" class="form-control" placeholder="客戶聯絡地址">
                                                    </div>
                                                    <div class="form-item">
                                                        <label class="d-block title-deco">聯絡電話</label>
                                                        <input type="text" class="form-control" placeholder="客戶聯絡電話">
                                                    </div>
                                                    <div class="form-item">
                                                        <label class="d-block title-deco">派工原因</label>
                                                        <input type="text" class="form-control" placeholder="派工原因">
                                                    </div>
                                                    <div class="form-item">
