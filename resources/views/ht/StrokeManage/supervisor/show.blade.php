...
<div class="main dispatch-form">
    <div class="main-content">
        <div class="container-fluid">
            <!-- 活動分析 -->
            <h3 class="page-title">派工單 <span>Management</span></h3>
                                ...
                                <div class="panel-body">
                                    <div class="tabbable">
                                        ...
                                        <div class="field">
                                            ...
                                            @endforeach
                                            <div>
                                                <a href="{{ route('ht.StrokeManage.supervisor.index',['organization'=>$organization]) }}"><button type="button" class="btn btn-default">返回</button></a>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
