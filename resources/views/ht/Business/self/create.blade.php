                                                ...
                                                <form>
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-item">
                                                            ...
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">拜訪</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">陌訪</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">洽機</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">看現場</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">送機器</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">收款</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">送文件</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">協助安裝</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">其他</label>
                                                            <label class="d-inline mr-m"><input type="radio" name="type" class="mr-s">支援</label>
                                                        </div>
                                                        <div class="form-item">
