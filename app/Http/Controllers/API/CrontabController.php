                                ...
                                if(empty($v->custoken)){    //只推播員工
                                    ...
                                    $response = $client->post('https://api.line.me/v2/bot/message/push', [
                                       ...
                                       'body' => json_encode([
                                        ...
                                        'messages' =>json_decode('[{"type":"flex","altText":"已傳送給您服務通知","contents":{"type":"bubble","body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":"服務通知","align":"center","size":"xl","weight":"bold"},{"type":"box","layout":"vertical","margin":"xxl","spacing":"sm","contents":[{"type":"box","layout":"horizontal","contents":[{"type":"text","text":" ","size":"md","wrap":true}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"'.$v->full_name.' 您好!","size":"md","wrap":true,"weight":"bold"}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"以下為本次的服務資訊 : ","size":"md","wrap":true,"weight":"bold"}]},{"type":"separator","margin":"md"},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":" ","size":"md","wrap":true}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"服務日期 : ","size":"md","wrap":true,"flex":2},{"type":"text","text":"'.$v->time.'","size":"md","wrap":true,"flex":4}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"服務項目 : ","size":"md","wrap":true,"flex":2},{"type":"text","text":"'.$v->work_type.'","size":"md","wrap":true,"flex":4}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"服務人員 : ","size":"md","wrap":true,"flex":2},{"type":"text","text":"'.$v->owner.'","size":"md","wrap":true,"flex":4}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"服務地址 : ","size":"md","wrap":true,"flex":2},{"type":"text","text":"'.$v->add.'","color":"#003C9D","size":"md","wrap":true,"flex":4,"action":{"type":"uri","uri":"https://maps.apple.com/?q='.urlencode($v->add).'"}}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"叫修紀錄 : ","size":"md","wrap":true,"flex":2},{"type":"text","text":"點此前往叫修紀錄","color":"#003C9D","size":"md","wrap":true,"flex":4,"action":{"type":"uri","uri":"https://liff.line.me/1654117129-7we0EZRp?case_id='.$v->id.'"}}]},{"type":"separator","margin":"md"},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":" ","size":"md","wrap":true}]},{"type":"box","layout":"horizontal","contents":[{"type":"text","text":"如有問題請撥打 : ","size":"md","wrap":true},{"type":"text","text":"'.$DEPT[0]->phone.'","color":"#003C9D","size":"md","wrap":true,"action":{"type":"uri","uri":"tel:'.$DEPT[0]->phone.'"}}]}]}]}}}]')
                                    ])
                                   ]);
                                }
                            }
