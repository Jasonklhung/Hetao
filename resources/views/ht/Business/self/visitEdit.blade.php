                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 wrap">
                                    <div class="panel" id="manager">
                                        ...
                                        <div class="panel-body">
                                            <div class="tabbable">
                                                <form method="post" enctype="multipart/form-data" action="{{ route('ht.Business.self.update',['organization'=>$organization,'id'=>$visit->id]) }}">
                                                    @csrf
                                                    <div class="col-sm-6">
                                                        <div class="form-item">
                                                            ...
                                                            <div class="datetime">
                                                                <div class="input-group date day-set">
                                                                    <input class="form-control" placeholder="請選擇日期" name="date" value="{{ $visit->date }}" type="text"> <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-item">
                                                            <label class="d-block"><span class="text-danger">* </span>業務人員</label>
                                                            <input type="text" class="form-control" name="business_name" value="{{ $visit->business_name }}">
                                                        </div>
                                                        <div class="form-item">
                                                            <label class="d-block"><span class="text-danger">* </span>拜訪時間</label>
                                                            <select class="form-control mr-s" name="time">
                                                                <option hidden disabled value="">請選擇</option>
                                                                @if($visit->time == '上午(AM)')
                                                                <option value="上午(AM)" selected="">上午(AM)</option>
                                                                <option value="下午(PM)">下午(PM)</option>
                                                                @elseif(($visit->time == '下午(PM)'))
                                                                <option value="上午(AM)">上午(AM)</option>
                                                                <option value="下午(PM)" selected="">下午(PM)</option>
                                                                @endif
                                                            </select>
                                                        </div>
                                                        <div class="form-item">
                                                            <label class="d-block"><span class="text-danger">* </span>業主名稱</label>
                                                            <input type="text" class="form-control" name="name" value="{{ $visit->name }}">
                                                        </div>
                                                        <div class="form-item">
                                                        ...
                                                        <div class="form-item">
                                                            ...
                                                            <input type="text" class="form-control" name="content" value="{{ $visit->content }}">
                                                        </div>
                                                    </div>    
                                                        ...
                                                        <div class="form-item">
                                                            ...
                                                            <div class="d-flex mb-s">
                                                                <select class="form-control mr-s area1" name="city">
                                                                    <option selected value="{{ $visit->city }}">{{ $visit->city }}</option>
                                                                </select>

                                                                <select class="form-control ml-s area2" name="area">
                                                                    <option selected value="{{ $visit->area }}">{{ $visit->area }}</option>
                                                                </select>
                                                            </div>    
                                                            <input type="text" class="form-control" placeholder="地址" name="address" value="{{ $visit->address }}">
                                                        </div>
                                                        <div class="form-item">
                                                            <label class="d-block"><span class="text-danger">* </span>聯絡電話</label>
                                                            <input type="number" class="form-control" placeholder="聯絡電話" name="phone" value="{{ $visit->phone }}">
                                                        </div>
                                                        <div class="form-item">
                                                            <label class="d-block">備註其他</label>
                                                            <textarea rows="5" class="form-control" placeholder="" name="other">{{ $visit->other }}</textarea>
                                                        </div>
                                                        <div class="form-item">
                                                        ...
                                                        <div class="form-item ">
                                                            <span class="d-block">狀態
                                                                <label class="switch follow-status">
                                                                    @if($visit->statusTrack == 'Y')
                                                                    <input type="checkbox" name="statusTrack" checked>
                                                                    @else
...
<script>
        ...
        $(document).ready(function(){
            //$(".area1").append('<option hidden value="" disabled>選擇縣市</option>');
